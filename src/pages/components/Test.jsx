...
import datashu from "../utils/Test1";
...
export default function Test() {
  ...
  const [timeLeft, setTimeLeft] = useState(30); // ⏱️ 30 секунд
  ...
  useEffect(() => {
    ...
    if (timeLeft === 0) {
      goNext(); // хугацаа дуусвал автоматаар дараагийн асуулт руу
      return;
    }
  ...
  const goNext = () => {
    ...
    if (next >= total) {
      ...
      setCurrentQ(next);
      setTimeLeft(30); // дараагийн асуултад шинэчилнэ
      setLocked(false);
    }
  };
